...
Go to: https://wealth-dashboard-77.preview.emergentagent.com
...
# Add Apple stock
curl -X POST "https://wealth-dashboard-77.preview.emergentagent.com/api/portfolios/add-stock?symbol=AAPL&quantity=10&purchase_price=150&purchase_date=2023-01-15" \
  -H "Authorization: Bearer $SESSION_TOKEN"

# View portfolio
curl "https://wealth-dashboard-77.preview.emergentagent.com/api/portfolios/my-portfolio" \
  -H "Authorization: Bearer $SESSION_TOKEN"
```
