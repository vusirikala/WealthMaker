...
export default function MultiPortfolioDashboard() {
  ...
  return (
    <div className="flex h-full overflow-hidden">
      ...
      >
        {/* Chat Header */}
        <div className="bg-gradient-to-r from-cyan-600 to-emerald-600 text-white p-4 flex items-center justify-between shadow-md flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white/80">Portfolio-specific advice</p>
            </div>
          </div>
          <button
