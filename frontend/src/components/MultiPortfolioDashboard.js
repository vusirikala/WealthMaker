...
export default function MultiPortfolioDashboard() {
  ...
  return (
    <div className="flex h-full overflow-hidden">
      ...
      >
        {/* Chat Header */}
        <div className="bg-gradient-to-r from-cyan-600 to-emerald-600 text-white p-4 flex items-center justify-between shadow-md flex-shrink-0 gap-3">
          ...
          <button
            ...
            className="p-2 hover:bg-white/30 rounded-lg transition-colors flex items-center gap-1.5 bg-white/10 flex-shrink-0"
            title="Close chat"
          >
            <span className="text-sm font-semibold hidden md:inline">Close</span>
