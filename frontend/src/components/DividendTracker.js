          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold text-gray-700 flex items-center">
                  Annual Income
                  <InfoTooltip text="Total dividend income you receive per year from all dividend-paying stocks in your portfolio. This is passive income generated by your investments." />
                </span>
              </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold text-gray-700 flex items-center">
                  Monthly Income
                  <InfoTooltip text="Your annual dividend income divided by 12. This gives you an estimate of monthly passive income, though actual payments vary by company dividend schedules (quarterly, monthly, etc.)." />
                </span>
              </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold text-gray-700 flex items-center">
                  Portfolio Yield
                  <InfoTooltip text="Annual dividend income as a percentage of your total portfolio value. Formula: (Annual Dividends / Portfolio Value) × 100. For example, 3% yield means you earn $3 annually for every $100 invested." />
                </span>
              </div>
