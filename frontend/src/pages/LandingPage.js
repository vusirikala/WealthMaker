          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 relative smooth-transition" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="text-center">
              ...
              <Button
                ...
                className="w-full bg-white hover:bg-gray-50 text-gray-900 border-2 border-gray-300 hover:border-gray-400 rounded-xl py-6 text-base font-semibold shadow-sm smooth-transition flex items-center justify-center gap-3"
              >
                {isProcessing ? (
                  <>
